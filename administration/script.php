...
// -------------- sinon lecture de la table data.scripts  -----------------------------
    ...
    if ($id !== "") {
        ...
        $script->code = "#Insert your code here\n";
        $script->output = "";
    }
...
function afficherFormScript($selectUser) {
    ...
    echo Form::select('language', $selectLanguage, "language", $script->language);
    $options = array('class' => 'form-control',
        'rows' => '20',
        'cols' => '80'
    );
    echo Form::textarea('code', $script->code, $options, 'code');
}
?>
...
<?php afficherFormScript($selectUser); ?>
                            ...
                            <div class="form-group" style="margin:10px;">
                                ...
                                <button  class="btn btn-primary" value="run" id="run" >Run </button>
...
echo Form::textarea('output', $script->output, $options, 'Output');
?>
                        </form>
                    </div>
                </div>
