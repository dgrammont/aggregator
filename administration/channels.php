                        ...
                        $.getJSON(feeds, function (data) {
                            ...
                            if (typeof data.feeds[0] !== 'undefined') {
                                ...
                                if (data.channel.field1)
                                    contenu += '<tr><td>' + data.channel.field1 + '</td><td>' + data.feeds[0].field1 + '<td/></tr>';
                                if (data.channel.field2)
                                    contenu += '<tr><td>' + data.channel.field2 + '</td><td>' + data.feeds[0].field2 + '<td/></tr>';
                                if (data.channel.field3)
                                    contenu += '<tr><td>' + data.channel.field3 + '</td><td>' + data.feeds[0].field3 + '<td/></tr>';
                                if (data.channel.field4)
                                    contenu += '<tr><td>' + data.channel.field4 + '</td><td>' + data.feeds[0].field4 + '<td/></tr>';
                                if (data.channel.field5)
                                    contenu += '<tr><td>' + data.channel.field5 + '</td><td>' + data.feeds[0].field5 + '<td/></tr>';
                                if (data.channel.field6)
                                    contenu += '<tr><td>' + data.channel.field6 + '</td><td>' + data.feeds[0].field6 + '<td/></tr>';
                                if (data.channel.field7)
                                    contenu += '<tr><td>' + data.channel.field7 + '</td><td>' + data.feeds[0].field7 + '<td/></tr>';
                                if (data.channel.field8)
                                    contenu += '<tr><td>' + data.channel.field8 + '</td><td>' + data.feeds[0].field8 + '<td/></tr>';
                                contenu += '</table>';
                            } else {
