...
/**----------------------------------------------------------------------------------
    ...
    @auteur   Théo Langlais (Touchard Washington le Mans)
    @date     May 2021
		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-12">
				...
				<div class="popin" style="min-height : 500px">	
					...
					<h3>Présentation de l'item "Journal de bord" </h3>
					<p> A chaque Ruche peut être associé un journal de bord, vous trouverez la liste de tous vos articles dans l'item "Journal de bord" de la page parcourir. 
					Ils y sont rassemblés du plus récent au plus ancien.</p> 
					<p> Le cadre à gauche indique le nombre d'articles publiés par année, il permet aussi d'afficher les articles les plus anciens</p>
					<p>Vous pouvez ajouter un nouvel article en cliquant sur le cadre "Que voulez-vous dire aujourd'hui", vous pouvez aussi modifier ou supprimer vos articles en cliquant sur le crayon ou sur la croix.</p>
					<br />
					<h3>L'espace de rédaction</h3>
					...
					<h3>Les options de publication</h3>
