...
try {
    ...
    if ($type == "json") {
        ...
        if ($result = $stmt->fetchObject()) {
            ...
            if ($result->field1 != "")
                $channel['field1'] = $result->field1;
            if ($result->field2 != "")
                $channel['field2'] = $result->field2;
            if ($result->field3 != "")
                $channel['field3'] = $result->field3;
            if ($result->field4 != "")
                $channel['field4'] = $result->field4;
            if ($result->field5 != "")
                $channel['field5'] = $result->field5;
            if ($result->field6 != "")
                $channel['field6'] = $result->field6;
            if ($result->field7 != "")
                $channel['field7'] = $result->field7;
            if ($result->field8 != "")
                $channel['field8'] = $result->field8;
            ...
            while ($feed = $stmt->fetchObject()) {
                ...
                if ($result->field1 != "")
                    $data['field1'] = Str::floatToString($feed->field1, $round);
                if ($result->field2 != "")
                    $data['field2'] = Str::floatToString($feed->field2, $round);
                if ($result->field3 != "")
                    $data['field3'] = Str::floatToString($feed->field3, $round);
                if ($result->field4 != "")
                    $data['field4'] = Str::floatToString($feed->field4, $round);
                if ($result->field5 != "")
                    $data['field5'] = Str::floatToString($feed->field5, $round);
                if ($result->field6 != "")
                    $data['field6'] = Str::floatToString($feed->field6, $round);
                if ($result->field7 != "")
                    $data['field7'] = Str::floatToString($feed->field7, $round);
                if ($result->field8 != "")
                    $data['field8'] = Str::floatToString($feed->field8, $round);
